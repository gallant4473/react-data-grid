...
var css_248z$e = ".cj343x0{background-color:inherit;border-bottom:1px solid var(--border-color);border-right:1px solid var(--border-color);contain:strict;contain:size layout style paint;outline:none;overflow:hidden;overflow:clip;padding:0 8px;text-overflow:ellipsis;white-space:nowrap}.cj343x0[aria-selected=true]{box-shadow:inset 0 0 0 2px var(--selection-color)}.csofj7r{position:sticky;z-index:1}.ch2wcw8{box-shadow:2px 0 5px -2px hsla(0,0%,53%,.3)}";
...
var css_248z$d = ".rnvodz5{--color:#000;--border-color:#ddd;--summary-border-color:#aaa;--background-color:#fff;--header-background-color:#f9f9f9;--row-hover-background-color:#f5f5f5;--row-selected-background-color:#dbecfa;--row-selected-hover-background-color:#c9e3f8;--checkbox-color:#005194;--checkbox-focus-color:#61b8ff;--checkbox-disabled-border-color:#ccc;--checkbox-disabled-background-color:#ddd;--selection-color:#66afe9;--font-size:14px;content-visibility:auto;background-color:var(--background-color);border:1px solid var(--border-color);box-sizing:border-box;color:var(--color);color-scheme:var(--color-scheme,light dark);contain:strict;contain:size layout style paint;direction:ltr;font-size:var(--font-size);height:350px;overflow:auto;user-select:none}@supports not (contain:strict){.rnvodz5{position:relative;z-index:0}}.rnvodz5 *,.rnvodz5 :after,.rnvodz5 :before{box-sizing:inherit}.rnvodz5.rdg-dark{--color-scheme:dark;--color:#ddd;--border-color:#444;--summary-border-color:#555;--background-color:#212121;--header-background-color:#1b1b1b;--row-hover-background-color:#171717;--row-selected-background-color:#1a73bc;--row-selected-hover-background-color:#1768ab;--checkbox-color:#94cfff;--checkbox-focus-color:#c7e6ff;--checkbox-disabled-border-color:#000;--checkbox-disabled-background-color:#333}.rnvodz5.rdg-light{--color-scheme:light}@media (prefers-color-scheme:dark){.rnvodz5:not(.rdg-light){--color:#ddd;--border-color:#444;--summary-border-color:#555;--background-color:#212121;--header-background-color:#1b1b1b;--row-hover-background-color:#171717;--row-selected-background-color:#1a73bc;--row-selected-hover-background-color:#1768ab;--checkbox-color:#94cfff;--checkbox-focus-color:#c7e6ff;--checkbox-disabled-border-color:#000;--checkbox-disabled-background-color:#333}}.vlqv91k.r1upfr80{cursor:move}";
styleInject(css_248z$d,{"insertAt":"top"});

const root = "rnvodz5";
const rootClassname = `rdg ${root}`;
const viewportDragging = "vlqv91k";
const viewportDraggingClassname = `rdg-viewport-dragging ${viewportDragging}`;

var css_248z$c = ".r1upfr80{background-color:var(--background-color);contain:strict;contain:size layout style paint;display:grid;grid-template-columns:var(--template-columns);grid-template-rows:var(--row-height);height:var(--row-height);left:0;line-height:var(--row-height);position:absolute;width:var(--row-width)}.r1upfr80:hover{background-color:var(--row-hover-background-color)}.r1upfr80[aria-selected=true]{background-color:var(--row-selected-background-color)}.r1upfr80[aria-selected=true]:hover{background-color:var(--row-selected-hover-background-color)}";
...
var css_248z$a = ".g1vzro7t{outline:none}.c1fsqdic{stroke:currentColor;stroke-width:1.5px;fill:transparent;margin-left:4px;vertical-align:middle}.c1fsqdic>path{transition:d .1s}";
  ...
  const {
    ...
    const columns = rawColumns.map(rawColumn => {
      ...
      if (rowGroup) {
        ...
        (_column$groupFormatte = column.groupFormatter) !== null && _column$groupFormatte !== void 0 ? _column$groupFormatte : column.groupFormatter = ToggleGroupFormatter;
      }
...
var css_248z$9 = ".r1v67ork{outline:none}.r1v67ork:after{box-shadow:inset 0 0 0 2px var(--selection-color);content:\"\";inset:0;pointer-events:none;position:absolute;z-index:2}.r1v67ork>.cj343x0:first-child{box-shadow:inset 2px 0 0 0 var(--selection-color)}";
styleInject(css_248z$9,{"insertAt":"top"});

const rowSelected = "r1v67ork";
...
var css_248z$8 = ".h1j9yp5q{cursor:pointer;display:flex}.h1j9yp5q:focus{outline:none}.h1e6at1o{flex-grow:1;overflow:hidden;overflow:clip;text-overflow:ellipsis}.a1t8izji{fill:currentColor}.a1t8izji>path{transition:d .1s}";
...
var css_248z$7 = ".c6l2wv1{touch-action:none}.c6l2wv1:after{bottom:0;content:\"\";cursor:col-resize;position:absolute;right:0;top:0;width:10px}";
...
var css_248z$6 = ".h10tskcx{background-color:var(--header-background-color);contain:strict;contain:size layout style paint;display:grid;font-weight:700;grid-template-columns:var(--template-columns);grid-template-rows:var(--header-row-height);height:var(--header-row-height);line-height:var(--header-row-height);outline:none;position:sticky;top:0;width:var(--row-width);z-index:3}.h10tskcx[aria-selected=true]{box-shadow:inset 0 0 0 2px var(--selection-color)}";
styleInject(css_248z$6,{"insertAt":"top"});

const headerRow = "h10tskcx";
...
var css_248z$5 = ".c6ra8a3,.cq910m0{background-color:#ccf}.cq910m0.c6ra8a3{background-color:#99f}";
...
function Cell({
  ...
  function handleClick() {
    ...
    selectCellWrapper((_column$editorOptions = column.editorOptions) === null || _column$editorOptions === void 0 ? void 0 : _column$editorOptions.editOnClick);
...
function Row({
  ...
  className = clsx(rowClassname, `rdg-row-${rowIdx % 2 === 0 ? 'even' : 'odd'}`, rovingClassName, rowClass === null || rowClass === void 0 ? void 0 : rowClass(row), className);
  const cells = [];
...
var css_248z$4 = ".g1yxluv3:not([aria-selected=true]){background-color:var(--header-background-color)}.g1yxluv3>.cj343x0:not(:last-child):not(.ch2wcw8){border-right:none}";
styleInject(css_248z$4,{"insertAt":"top"});

const groupRow = "g1yxluv3";
...
var css_248z$3 = ".skuhp55.r1upfr80{grid-template-rows:var(--summary-row-height);height:var(--summary-row-height);line-height:var(--summary-row-height);position:sticky;z-index:3}.sf8l5ub>.cj343x0{border-top:2px solid var(--summary-border-color)}";
styleInject(css_248z$3,{"insertAt":"top"});

const summaryRow = "skuhp55";
const summaryRowBorderClassname = "sf8l5ub";
...
var css_248z$2 = ".cis5rrm.rdg-cell{padding:0}";
...
function EditCell({
  ...
  function onKeyDown(event) {
    if (event.key === 'Escape') {
      ...
      const onNavigation = (_column$editorOptions2 = (_column$editorOptions3 = column.editorOptions) === null || _column$editorOptions3 === void 0 ? void 0 : _column$editorOptions3.onNavigation) !== null && _column$editorOptions2 !== void 0 ? _column$editorOptions2 : onEditorNavigation;
  ...
  const className = getCellClassname(column, 'rdg-editor-container', typeof cellClass === 'function' ? cellClass(row) : cellClass, !((_column$editorOptions4 = column.editorOptions) !== null && _column$editorOptions4 !== void 0 && _column$editorOptions4.renderFormatter) && cellEditing);
  return /*#__PURE__*/jsxRuntime.jsx("div", {
    role: "gridcell",
    "aria-colindex": column.idx + 1,
    "aria-colspan": colSpan,
    ...
    children: column.editor != null && /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
      children: [/*#__PURE__*/jsxRuntime.jsx(column.editor, {
        ...
        onRowChange: onRowChange,
        onClose: onClose
      }), ((_column$editorOptions5 = column.editorOptions) === null || _column$editorOptions5 === void 0 ? void 0 : _column$editorOptions5.renderFormatter) && /*#__PURE__*/jsxRuntime.jsx(column.formatter, {
        column: column,
        row: row,
        isCellSelected: true,
        onRowChange: onRowChange
...
var css_248z$1 = ".c1w9bbhr{background-color:var(--selection-color);bottom:0;cursor:move;height:8px;position:absolute;right:0;width:8px}.c1w9bbhr:hover{background-color:var(--background-color);border:2px solid var(--selection-color);height:16px;width:16px}";
styleInject(css_248z$1,{"insertAt":"top"});

const cellDragHandle = "c1w9bbhr";
...
function DataGrid({
  ...
  (_rowHeight = rowHeight) !== null && _rowHeight !== void 0 ? _rowHeight : rowHeight = 35;
  ...
  const RowRenderer = rowRenderer !== null && rowRenderer !== void 0 ? rowRenderer : Row$1;
  const cellNavigationMode = rawCellNavigationMode !== null && rawCellNavigationMode !== void 0 ? rawCellNavigationMode : 'NONE';
  (_enableVirtualization = enableVirtualization) !== null && _enableVirtualization !== void 0 ? _enableVirtualization : enableVirtualization = true;
  ...
  function scrollToCell({
    ...
    if (typeof idx === 'number' && idx > lastFrozenColumnIndex) {
      ...
      (_rowIdx = rowIdx) !== null && _rowIdx !== void 0 ? _rowIdx : rowIdx = selectedPosition.rowIdx;
  ...
  return /*#__PURE__*/jsxRuntime.jsxs("div", {
    ...
    children: [/*#__PURE__*/jsxRuntime.jsx(HeaderRow$1, {
      ...
      }), summaryRows === null || summaryRows === void 0 ? void 0 : summaryRows.map((row, rowIdx) => {
