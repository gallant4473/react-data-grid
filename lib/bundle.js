  ...
  return /*#__PURE__*/jsx("div", {
    ...
    children: column.editor != null && /*#__PURE__*/jsxs(Fragment, {
      children: [/*#__PURE__*/jsx(column.editor, {
        ...
        otherFunctions: otherFunctions,
        onClose: onClose
      }), ((_column$editorOptions5 = column.editorOptions) == null ? void 0 : _column$editorOptions5.renderFormatter) && /*#__PURE__*/jsx(column.formatter, {
        column: column,
        row: row,
        otherFunctions: otherFunctions,
        isCellSelected: true,
    ...
    if (checked) {
      ...
      if (isShiftClick && previousRowIdx !== -1 && previousRowIdx !== rowIdx) {
        ...
        for (let i = previousRowIdx + step; i !== rowIdx; i += step) {
          ...
          if (!(rowsDisabled != null && rowsDisabled.has(rowKeyGetter(row)))) {
...
export { RowWithRef as Row, SELECT_COLUMN_KEY, SelectCellFormatter, SelectColumn, SortableHeaderCell, TextEditor, ToggleGroupFormatter, ValueFormatter, DataGrid$1 as default, useCalculatedColumns, useCombinedRefs, useFocusRef, useGridDimensions, useLatestFunc, useLayoutEffect, useRovingCellRef, useRovingRowRef, useRowSelection, useViewportColumns, useViewportRows };
